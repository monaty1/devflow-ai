export const CODE_REVIEW_WORKER_SOURCE = `
// --- Self-contained Code Review Logic ---
...
const LANGUAGE_PATTERNS = {
  javascript: [
    ...
    { pattern: /console\.log\(/g, severity: "info", category: "maintainability", message: "Console log detected", suggestion: "Remove before deployment" }
  ],
  typescript: [
...
function generateRefactoredCode(code, language, issues) {
  let refactored = code;
